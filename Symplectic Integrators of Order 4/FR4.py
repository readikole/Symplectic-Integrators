...
while i<N-1:
    ...
    x_a2[i+1] = x_a2[i+1]  + a2*h*px_b2[i+1]
    y_a2[i+1] = y_a2[i+1] + a2*h*py_b2[i+1]
...
plt.grid()
plt.loglog(np.linspace(0,N, n), new_error, marker='o')
plt.show()
...
while i<N-1:
    ...
    x2_a2[i+1] = x2_a2[i+1]  + a2*h*px2_b2[i+1]
    y2_a2[i+1] = y2_a2[i+1] + a2*h*py2_b2[i+1]
...
while i<N-1:
    ...
    x3_a2[i+1] = x3_a2[i] + a2*h*px3_b2[i]
    y3_a2[i+1] = y3_a2[i] + a2*h*py3_b2[i]

    px3_b1[i+1] = px3_b2[i] - b1*h*(-2*E*x3_a2[i+1] + 6*A*x3_a2[i+1]**5 + 4*B*x3_a2[i+1]**3*(y3_a2[i+1]**2) + 2*B*x3_a2[i+1]*(y3_a2[i+1]**4))
    py3_b1[i+1] = py3_b2[i] - b1*h*(-2*E*x3_a2[i+1] + 6*A*y3_a2[i+1]**5  + 4*B*x3_a2[i+1]**4*(y3_a2[i+1]**3) + 2*B*y3_a2[i+1]*(x3_a2[i+1]**4))
